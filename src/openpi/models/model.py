...
class Observation(Generic[ArrayT]):
    ...
    def from_dict(cls, data: at.PyTree[ArrayT]) -> "Observation[ArrayT]":
        ...
        return cls(
            ...
            state=data["state"],
            valid_data=data["valid_data"] if 'valid_data' in data else np.zeros((data["state"].shape[0], 10)) > 0,
            quality=data["quality"] if "quality" in data else np.ones((data["state"].shape[0], 10)),
